<main>
	<section id="home" class="pt-32 pb-96">
		<div class="text-center">
			<h1 class="text-6xl py-2 mt-20 text-primary-500 animate-fade-up animate-delay-1000">Welcome to TunePulse</h1>
			<p class="text-3xl mt-8 animate-flip-up animate-delay-1000">Your Symphony of Spotify Insights! <br />
				The website that displays your personal Spotify listening statistics<br /> without storing any user information.<br />
				Your tune, your pulse!</p>
		</div>
	</section>

	<section id="features" class="pt-10 pb-80">
		<div class="text-center">
			<h2 class="text-6xl py-2 mt-20 text-primary-500">Features</h2>
			<p class="text-3xl mt-8 pb-20 px-80">TunePulse is a place where you can check out your Spotify listening stats without it keeping any of your personal info.
				It's a project I'm working on, still in progress, and I'm excited to share the journey with you. 
		...
		<div class="ml-10 md:ml-32 lg:ml-52">
			<ol class="relative border-s border-gray-200 dark:border-gray-700">                  
				...
				<li class="ms-6">
					...
					<time class="block mb-1 text-base font-normal leading-none text-gray-400 dark:text-gray-500">TBA</time>
					<p class="text-lg font-normal text-gray-500 dark:text-tertiary-500">Planned: More advanced statistics. This should be a very solid version (end goal - new ideas are always welcome). Many features and a solid statistics site.</p>
				</li>
			</ol>
		</div>
	</section>
